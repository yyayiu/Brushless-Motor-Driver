...
::Fixed input checking order bug
::Can now use hex file paths other than ./output
::5/2/2017

@if [%1] == [] (
	@echo ERROR: Missing argument 1 (the *.hex file location^). Please input the location in Keil. 
	@goto missing_arg
) else if not exist "%1" (
